class BrightnessfService extends Service {
    ...
    constructor() {
        ...
        // setup monitor
        const brightnessf = `/sys/class/backlight/${this.#interface}/brightness`;
        Utils.monitorFile(brightnessf, () => this.#onChange());
...
const service = new BrightnessfService;
